...
interface LuxuraCarouselSliderProps {
...
export function LuxuraCarouselSlider({
  ...
  return (
    <div className="relative w-full h-[280px] sm:h-[320px] md:h-[360px] lg:h-[420px] xl:h-[600px] rounded-xl overflow-hidden">
      <Swiper
        onBeforeInit={(swiper) => {
...
export default LuxuraCarouselSlider;
