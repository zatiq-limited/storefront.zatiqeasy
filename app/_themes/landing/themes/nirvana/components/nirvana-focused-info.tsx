...
export function NirvanaFocusedInfo({
  content,
  onBuyNow,
}: NirvanaFocusedInfoProps) {
  if (!content) {
    return null;
  }
  ...
  return (
    <div className="container mx-auto px-4 relative overflow-hidden">
      <div className="absolute inset-0 bg-linear-to-br from-landing-primary/5 via-landing-primary/10 to-landing-secondary/5" />
          ...
          <div className="relative z-10 space-y-8 md:space-y-12 text-center">
            ...
            {content.title && (
              <div className="relative inline-block group">
                <div className="absolute -inset-1 bg-linear-to-r from-landing-primary/20 to-landing-secondary/20 rounded-lg blur-sm opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200" />
                <h2 className="relative px-1 md:px-7 py-4 bg-white/50 backdrop-blur-sm rounded-lg text-4xl md:text-6xl font-extrabold text-center bg-linear-to-r from-landing-primary to-landing-secondary bg-clip-text text-transparent transition-all duration-300 ease-out hover:scale-[1.02]">
                  {content.title}
                </h2>
              </div>
            )}
