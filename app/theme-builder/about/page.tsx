/**
 * ========================================
 * THEME BUILDER - ABOUT PAGE
 * ========================================
 *
 * Renders the about page using theme builder's published sections
...
export default function ThemeBuilderAboutPage() {
  const { aboutPage, isLoading, error } = useThemeBuilder();
  ...
  const sections = aboutPage?.data?.sections || [];
      ...
      <main className="flex items-center justify-center min-h-[50vh]">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            No sections have been published for the about page yet.
          </p>
        </div>
      </main>
    );
  ...
  return (
    <main className="zatiq-theme-builder-about-page">
