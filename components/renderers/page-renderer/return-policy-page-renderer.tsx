...
} from "@/components/renderers/block-renderer/block-components/return-policy";

interface ReturnPolicyPageRendererProps {
  sections: Section[];
}

export default function ReturnPolicyPageRenderer({ sections }: ReturnPolicyPageRendererProps) {
