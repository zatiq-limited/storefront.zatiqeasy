          ...
          <div className="flex items-center justify-between mt-auto gap-2">
            ...
            {quickAddEnabled && (
              <>
                {isOutOfStock ? (
                  <button
                    className="w-16 h-8 sm:w-18 sm:h-9 lg:w-20 lg:h-10 border-none rounded text-xs sm:text-xs lg:text-sm font-bold leading-6 transition-all duration-300 flex items-center justify-center gap-1 cursor-not-allowed opacity-60"
                  ...
                  <div
                    className="h-8 sm:h-9 lg:h-10 border rounded flex items-center justify-between overflow-hidden"
                    style={{ borderColor: buttonBgColor }}
                  >
                    <button
                      className="h-full px-2 flex items-center justify-center hover:bg-gray-100 transition-colors"
                      style={{ color: buttonBgColor }}
                      onClick={(e) => { e.preventDefault(); e.stopPropagation(); onDecrement?.(); }}
                    >
                      <svg className="w-3 h-3 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14" /></svg>
                    </button>
                    <input
                      type="text"
                      inputMode="numeric"
                      ...
                      className="w-8 sm:w-10 text-center text-xs sm:text-sm font-medium bg-transparent focus:outline-none text-gray-900"
                    ...
                    >
                      <svg className="w-3 h-3 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 5v14M5 12h14" /></svg>
                    </button>
                  </div>
                ) : (
                  <button
                    className="w-16 h-8 sm:w-18 sm:h-9 lg:w-20 lg:h-10 border-none rounded text-xs sm:text-xs lg:text-sm font-bold leading-6 transition-all duration-300 flex items-center justify-center gap-1 cursor-pointer hover:opacity-90"
