      ...
      >
        ...
        <div className="px-3 pt-2 pb-3 sm:px-4 sm:pt-3 sm:pb-4 lg:px-5 lg:pt-3 lg:pb-6 flex flex-col flex-1 bg-white">
          ...
          <div className="flex items-center justify-between mt-auto gap-2">
            ...
            {quickAddEnabled && (
              <button
                className={`w-16 h-8 sm:w-18 sm:h-9 lg:w-20 lg:h-10 border-none rounded text-xs sm:text-xs lg:text-sm font-bold leading-6 transition-all duration-300 flex items-center justify-center gap-1 ${
                  isOutOfStock
