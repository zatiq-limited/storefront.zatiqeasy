/**
 * ProductCard10 - Minimal Centered Design
...
export default function ProductCard10({
  ...
  return (
    <div className="bg-white rounded overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer">
      <Link href={`/products/${handle}`} className="block">
        ...
        <div className="p-2 sm:p-3 text-center">
          ...
          {/* Price */}
          <span
            className="text-xs sm:text-sm font-semibold block mb-2"
          ...
          <div className="hidden sm:flex gap-2 justify-center">
            {quickAddEnabled && (
              <>
                {isOutOfStock ? (
                  <button
                    className="px-3 h-8 sm:px-4 sm:h-9 text-xs sm:text-sm rounded font-medium cursor-not-allowed opacity-60"
                  ...
                  <div
                    className="h-8 sm:h-9 border rounded flex items-center justify-between overflow-hidden"
                  ...
                  <button
                    className="px-3 h-8 sm:px-4 sm:h-9 text-xs sm:text-sm rounded font-medium transition-opacity hover:opacity-90"
                    style={{ backgroundColor: buttonBgColor, color: buttonTextColor }}
                    onClick={(e) => {
                      e.preventDefault();
                      onAddToCart?.();
            ...
            {buyNowEnabled && !isOutOfStock && !isInCart && (
              <button
                className="px-3 h-8 sm:px-4 sm:h-9 text-xs sm:text-sm rounded font-medium border-2 transition-all hover:opacity-80"
