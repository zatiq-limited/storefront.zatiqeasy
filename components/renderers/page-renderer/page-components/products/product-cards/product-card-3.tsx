        ...
        <div className="p-2.5 sm:p-3 lg:p-4 flex flex-col flex-1 bg-white">
          ...
          {quickAddEnabled && (
            <>
              {isOutOfStock ? (
                <button
                  className="w-full h-10 sm:h-12 lg:h-14 border border-gray-300 rounded flex items-center justify-center text-xs sm:text-sm lg:text-base font-medium gap-2 transition-all duration-300 leading-6 mb-2 mt-auto cursor-not-allowed opacity-60"
                ...
                <div
                  className="w-full h-10 sm:h-12 lg:h-14 border rounded flex items-center justify-between mb-2 mt-auto overflow-hidden"
