          ...
          <div className="hidden sm:flex gap-2">
            {quickAddEnabled && (
              <>
                {isOutOfStock ? (
                  <button
                    className="px-3 h-7 sm:px-4 sm:h-8 text-[10px] sm:text-xs rounded font-medium cursor-not-allowed opacity-60"
                  ...
                  <div
                    className="h-7 sm:h-8 border rounded flex items-center justify-between overflow-hidden"
                    style={{ borderColor: buttonBgColor }}
                  >
                    <button
                      className="h-full px-2 sm:px-3 flex items-center justify-center hover:bg-gray-100 transition-colors"
                    ...
                    <input
                      ...
                      className="w-8 sm:w-12 text-center text-xs sm:text-sm font-medium bg-transparent focus:outline-none text-gray-900"
