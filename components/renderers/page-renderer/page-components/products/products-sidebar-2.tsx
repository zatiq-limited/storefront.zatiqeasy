/**
 * ========================================
 * PRODUCTS SIDEBAR 2 - SIMPLE STYLE
 * ========================================
 *
 * Simpler sidebar with categories, price filter, colors, and sizes
 */
...
export default function ProductsSidebar2({
  showCategories = true,
              ...
              return (
                <label key={cat.id} className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    checked={isSelected}
                    onChange={(e) =>
                      onCategoryChange && onCategoryChange(String(cat.id), e.target.checked)
                    }
