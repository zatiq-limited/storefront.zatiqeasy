        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6">
              {renderInfoItem(
                s.info1Icon || "map-pin",
                s.info1Label || "Address",
                s.info1Content || "14 Ringe lane, Las Vegas, NV 89156",
                s.info1Link
              )}
              {renderInfoItem(
                s.info2Icon || "phone",
                s.info2Label || "Phone",
                s.info2Content || "+00-1234567890",
                s.info2Link
              )}
              {renderInfoItem(
                s.info3Icon || "mail",
                s.info3Label || "Email",
                s.info3Content || "demo@support.com",
                s.info3Link
              )}
            </div>
