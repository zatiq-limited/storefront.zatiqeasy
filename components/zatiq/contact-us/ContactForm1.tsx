        ...
        {status === "success" ? (
          <div className="max-w-2xl mx-auto text-center py-12">
            ...
            <button
              ...
              style={{ backgroundColor: submitButtonBgColor || submitButtonColor || "#111827" }}
            >
          ...
          <form onSubmit={handleSubmit} className="max-w-5xl mx-auto">
                ...
                {otherFields.map((field) => (
                  <div key={field.id}>
                    ...
                    <input
                      ...
                      className="w-full px-6 py-4 rounded-full border transition-colors text-sm focus:outline-none focus:ring-2"
                      style={{
                        backgroundColor: inputBgColor || "#F9FAFB",
                        borderColor: inputBorderColor || "#E5E7EB",
                        color: inputTextColor || "#111827",
                      }}
                    />
                  </div>
                ))}
                ...
                {textareaFields.map((field) => (
                  <div key={field.id} className="flex-grow">
                    ...
                    <textarea
                      ...
                      value={formData[field.settings.name || ""] || ""}
                      onChange={handleChange}
                      className="w-full h-full min-h-[200px] px-6 py-4 rounded-3xl border transition-colors text-sm resize-none focus:outline-none focus:ring-2"
                      style={{
                        backgroundColor: inputBgColor || "#F9FAFB",
                        borderColor: inputBorderColor || "#E5E7EB",
                        color: inputTextColor || "#111827",
            ...
            <div className="flex justify-end mt-6">
              <button
                ...
                style={{
                  backgroundColor: submitButtonBgColor || submitButtonColor || "#111827",
