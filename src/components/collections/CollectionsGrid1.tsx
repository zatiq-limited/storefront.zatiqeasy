            ...
            {[...Array(6)].map((_, i) => (
              <div
                ...
                className={`animate-pulse bg-gray-200 rounded-2xl ${
                  i === 0 && showFeaturedLarge ? "md:col-span-2 md:row-span-2 aspect-[12/9]" : "aspect-[4/3]"
                }`}
              />
            ))}
          </div>
      ...
      <section className="py-16 md:py-24" style={{ backgroundColor }}>
        <div className="max-w-[1440px] mx-auto px-4 2xl:px-0">
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">Add categories to see them displayed here</p>
          </div>
        </div>
      </section>
    );
      ...
      <div className="max-w-[1440px] mx-auto px-4 2xl:px-0">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {collections.map((collection, index) => {
            ...
            const spanClass = isFirstCard && showFeaturedLarge ? "md:col-span-2 md:row-span-2" : "";
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className={`relative overflow-hidden ${isFirstCard && showFeaturedLarge ? "aspect-[12/9]" : "aspect-[4/3]"}`}>
                    <Image
                      ...
                      {showDescription && collection.description && (
                        <p
                          className={`text-white/95 line-clamp-2 mb-4 ${
                            isFirstCard && showFeaturedLarge ? "text-base md:text-lg" : "text-sm"
                          }`}
                        >
