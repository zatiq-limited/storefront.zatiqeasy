...
export default function CollectionsHero2({
  ...
  const subtitle = s.subtitle || "Explore our handpicked collections crafted for every occasion and trend";
  ...
  // Image settings
  const image = s.image || "https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=1200&q=80";
  ...
  return (
    <section className="relative overflow-hidden" style={{ backgroundColor }}>
      <div className="max-w-[1440px] mx-auto px-4 2xl:px-0">
        <div className={`grid lg:grid-cols-2 gap-0 min-h-[500px] lg:min-h-[600px] ${isImageLeft ? "lg:flex-row-reverse" : ""}`}>
          {/* Content Side */}
          <div
          ...
          >
            <div className="max-w-xl">
              {/* Breadcrumb */}
              {showBreadcrumb && (
                <nav className="flex items-center gap-2 text-sm mb-6" style={{ color: breadcrumbColor }}>
              ...
              {badge && (
                ...
                >
                  ...
                  />
                  <span className="text-sm font-semibold uppercase tracking-wider" style={{ color: buttonTextColor }}>
                    {badge}
                  </span>
                </div>
              )}
              ...
              {showCollectionCount && collectionCount > 0 && (
                <p className="text-sm mb-8" style={{ color: collectionCountColor }}>
