...
export default function StaticBanner3({ settings, blocks, pageData }: StaticBanner3Props) {
  return (
    <div className="relative w-full h-[410px] lg:h-[440px] xl:h-[463px] bg-black overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0">
        <img
          src={settings?.backgroundImage || "/assets/banner/banner-3.png"}
          alt={settings?.backgroundImageAlt || "Product Background"}
      ...
      <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6 md:px-8">
        <div className="text-center">
          ...
          <h1 className="text-white font-bold leading-none mb-4 sm:mb-5 md:mb-6 lg:mb-7 text-3xl sm:text-4xl md:text-5xl lg:text-[60px] tracking-tight">
            {settings?.heading || "Best Discounts 2025"}
          </h1>
          ...
          {/* CTA Button */}
          <button 
            className="bg-[#4169E1] text-white font-medium hover:bg-[#3758CC] transition-colors text-sm sm:text-[15px] py-3 sm:py-[14px] px-8 sm:px-10 md:px-11 rounded-[3px] tracking-[0.2px]"
