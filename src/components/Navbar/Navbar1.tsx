      ...
      <div className="flex justify-between items-center gap-2">
        <div className="flex items-center gap-2 sm:gap-4 md:gap-10">
          ...
          <div className="hidden lg:flex items-center gap-8">
            <a href="#" className="text-gray-700 hover:text-blue-600 font-inter font-medium text-sm leading-[18px] transition-colors whitespace-nowrap">
              Handbags
            </a>
            <a href="#" className="text-gray-700 hover:text-blue-600 font-inter font-medium text-sm leading-[18px] transition-colors whitespace-nowrap">
              Watches
        ...
        <div className="flex items-center gap-1 sm:gap-2 md:gap-5 shrink-0">
          ...
          >
            {isMobileMenuOpen ? (
              ...
              <img src="/assets/menu_icon.svg" alt="Menu" className="w-6 h-6 sm:w-6 sm:h-6" />
            )}
          </button>
        </div>
      </div>
