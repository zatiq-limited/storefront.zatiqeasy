...
const defaultProducts = [
  {
    id: 1,
    image: 'https://images.unsplash.com/photo-1579586337278-3befd40fd17a?w=282&h=228&fit=crop&q=80',
    discount: '25% Off',
    category: 'Watches',
  ...
  {
    id: 2,
    image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=282&h=228&fit=crop&q=80',
    discount: '30% Off',
    category: 'Audio',
  ...
  {
    id: 3,
    image: 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=282&h=228&fit=crop&q=80',
    discount: '20% Off',
    category: 'Smartwatch',
  ...
  {
    id: 4,
    image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=282&h=228&fit=crop&q=80',
    discount: '15% Off',
    category: 'Speakers',
...
export default function ProductCards3({ settings, blocks, pageData }: ProductCards3Props) {
        ...
        {products.map((product: any) => (
          ...
          >
            ...
            <div style={{ 
              ...
              {/* Add to Cart Button */}
              <div style={{ paddingLeft: '18px', paddingRight: '18px', marginBottom: '8px' }}>
                <button
                  style={{
                    width: '100%',
                    height: '48px',
              ...
              {/* Buy Now Button */}
              <div style={{ paddingLeft: '18px', paddingRight: '18px', paddingBottom: '18px' }}>
                <button
                  style={{
                    width: '100%',
                    height: '48px',
                ...
                >
                  ...
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path 
                      d="M8.5 3L13 7.5M13 7.5L8.5 12M13 7.5H3" 
                      stroke="#3B82F6" 
                      strokeWidth="1.5" 
                      strokeLinecap="round" 
                      strokeLinejoin="round"
