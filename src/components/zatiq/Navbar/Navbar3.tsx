...
const Navbar3: React.FC = () => {
  ...
  return (
    <nav className="bg-white mb-1">
        ...
        <div className="flex justify-center items-center gap-2">
          ...
          <div className="shrink-0">
            <img
              src={logoImage}
              alt="nextek"
              className="h-5 w-20 sm:h-6 sm:w-24 md:h-10 md:w-44"
            />
          </div>
          ...
          <div className="hidden md:flex flex-1 max-w-lg min-h-11 mx-4 lg:mx-12">
            <div className="relative w-full">
              ...
              <input
                type="text"
                placeholder="Discover exactly what you need with a simple search"
      ...
      <div className="hidden lg:block min-h-12 bg-[#3465F0] px-4 md:px-8 lg:px-16">
                    ...
                    {category.hasDropdown && (
                      <ChevronDown
                        className={`w-4 h-4 transition-transform ${
                          openDropdown === `mobile-${category.name}`
                            ? "rotate-180"
                            : ""
                        }`}
                      />
