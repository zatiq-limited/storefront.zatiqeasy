    ...
    <div className="w-full pb-8 sm:pb-14 py-0">
      ...
      >
        <CarouselContent className="ml-0 h-full">
          {heroSlides.map((slide, index) => (
            <CarouselItem key={slide.id} className="pl-0 h-full">
              <div className="relative w-full min-h-[500px] sm:min-h-[600px] lg:h-[716px]">
                {/* Background Image */}
        ...
        {showArrows && totalSlides > 1 && (
          <button
            onClick={handlePrev}
            className="hidden md:flex absolute left-4 lg:left-10 top-1/2 -translate-y-1/2 w-8 h-8 lg:w-10 lg:h-10 items-center justify-center transition-all z-20 lg:opacity-0 lg:group-hover:opacity-100"
        ...
        {showArrows && totalSlides > 1 && (
          <button
            onClick={handleNext}
            className="hidden md:flex absolute right-4 lg:right-10 top-1/2 -translate-y-1/2 w-8 h-8 lg:w-10 lg:h-10 items-center justify-center transition-all z-20 lg:opacity-0 lg:group-hover:opacity-100"
