    ...
    <div className="font-sans flex gap-6 justify-center p-1">
      ...
      >
        ...
        <div className="p-4 h-[213px] flex flex-col bg-white">
          ...
          {quickAddEnabled && (
            <button
              className="w-full h-14 border-none rounded flex items-center justify-center cursor-pointer text-base font-medium gap-2 transition-all duration-300 leading-6 hover:opacity-90 mt-auto"
