...
const ProductCards2: React.FC<ProductCards2Props> = ({
  id,
  title = "Product Title",
  subtitle,
  vendor,
        ...
        <div className="p-2.5 sm:p-3 lg:p-4 flex flex-col flex-1 bg-white">
          ...
          {quickAddEnabled && (
            <button
              ...
              className="w-full h-14 border-none rounded flex items-center justify-center cursor-pointer text-base font-medium gap-2 transition-all duration-300 leading-6 hover:opacity-90 mt-auto disabled:opacity-50 disabled:cursor-not-allowed"
