    ...
    <div className="font-poppins w-full h-full">
      ...
      >
        ...
        >
          {/* Add to Cart Button */}
          {quickAddEnabled && (
            <button className="w-full h-12 lg:h-14 rounded bg-white flex items-center justify-center cursor-pointer text-sm font-medium text-[#3B82F6] transition-all duration-300 leading-5 hover:bg-blue-50">
              Add to Cart
            </button>
          )}
