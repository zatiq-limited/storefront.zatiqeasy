...
const ProductCards8: React.FC<ProductCards8Props> = ({
  title = "Product Title",
  vendor,
  price,
  currency = "BDT",
      ...
      >
        ...
        <div className="px-3 sm:px-4 lg:px-5 pt-2 sm:pt-3 pb-3 sm:pb-4 lg:pb-6 flex flex-col flex-1 bg-white">
          ...
          <div className="flex items-center justify-between mt-auto gap-2">
            ...
            {/* Add Button */}
            {quickAddEnabled && (
              <button className="w-16 h-8 sm:w-18 sm:h-9 lg:w-20 lg:h-10 border-none rounded bg-[#F53E32] text-white text-xs sm:text-sm font-bold leading-6 cursor-pointer transition-all duration-300 flex items-center justify-center gap-1 hover:bg-[#DC2626] active:scale-95 shrink-0">
                <svg
                  className="w-3 h-3 sm:w-3.5 sm:h-3.5 lg:w-[14px] lg:h-[14px]"
                  viewBox="0 0 14 14"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
