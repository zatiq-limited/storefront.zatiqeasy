    ...
    <div className="font-poppins w-full h-full">
      ...
      >
                ...
                <div className="flex sm:hidden gap-1.5">
                  ...
                  {buyNowEnabled && (
                    <button className="w-8 h-8 rounded-full bg-[#F55157] flex items-center justify-center cursor-pointer transition-all duration-300 active:scale-95 shadow-md">
                      <svg className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M16 11V7C16 4.791 14.209 3 12 3C9.791 3 8 4.791 8 7V11M5 9H19L20 21H4L5 9Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </button>
                  )}
                </div>
        ...
        >
          {/* Add to Cart Button */}
          {quickAddEnabled && (
            <button className="w-full h-12 lg:h-14 border border-[#3B82F6] rounded bg-white flex items-center justify-center cursor-pointer text-sm lg:text-base font-medium text-[#3B82F6] transition-all duration-300 leading-6 hover:bg-blue-50">
              Add to Cart
            </button>
          )}
