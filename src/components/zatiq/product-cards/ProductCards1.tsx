        ...
        <div className="p-2.5 sm:p-3 lg:p-4 flex flex-col flex-1">
          ...
          {quickAddEnabled && (
            <button
              ...
              className="w-full h-14 border border-[#EEEEEE] rounded flex items-center justify-center cursor-pointer text-base leading-6 font-normal gap-2 transition-all duration-300 hover:opacity-90 mt-auto disabled:opacity-50 disabled:cursor-not-allowed"
