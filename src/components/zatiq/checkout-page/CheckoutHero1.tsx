                  ...
                  >
                    ...
                    <div
                      className={`
                        ...
                        ${
                          isCompleted
                            ? "bg-linear-to-br from-violet-500 to-purple-600 border-violet-500 text-white shadow-lg shadow-violet-500/30"
                            : ""
                        }
                        ${
                          isCurrent
                            ? "bg-white border-violet-500 text-violet-600 shadow-lg shadow-violet-500/20 scale-110"
                            : ""
                        }
                        ${
                          isUpcoming
