        ...
        <div className={cn(
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-violet-600 mt-1 font-medium">{option.delivery_time}</p>
                      </div>
                    ...
                    >
                      <div className="flex items-center gap-3 mb-2">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-violet-100 to-purple-100 flex items-center justify-center">
                          <span className="text-xl">{method.id === "bkash" ? "💳" : method.id === "cod" ? "💵" : "💰"}</span>
                        </div>
                        <div className="flex-1">
          ...
          <div className={cn(layout === "two-column" ? "lg:col-span-1" : "")}>
            <div className={cn(
                ...
                {orderItems.map((item) => (
                  <div key={item.product_id} className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-medium text-sm text-gray-900 line-clamp-2">{item.product_name}</h3>
                  ...
                  <div className="flex gap-2">
                    ...
                    {appliedPromo ? (
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-gradient-to-r from-violet-600 to-purple-600 text-white rounded-lg text-sm font-medium hover:from-violet-700 hover:to-purple-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                      >
              ...
              {/* Place Order Button */}
              <button className="w-full py-4 bg-gradient-to-r from-violet-600 to-purple-600 text-white rounded-xl text-base font-bold hover:from-violet-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl shadow-violet-500/30">
                Place Order
              </button>
