...
const TeamCard: React.FC<{ member: TeamMember; borderRadius: string }> = ({
  member,
  borderRadius,
}) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-x-0 bottom-0 bg-linear-to-t from-black/80 via-black/50 to-transparent ${
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6">
        ...
        <p className="text-white/80 text-sm md:text-base">{member.role}</p>
