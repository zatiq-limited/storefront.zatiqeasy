...
const defaultLogoImage = '/assets/nav/logo2.png';
...
const Navbar4: React.FC<Navbar4Props> = ({
  ...
  const menuLinks = menu_items && menu_items.length > 0 ? menu_items : defaultMenuItems;
  ...
  return (
    <nav
      className={`py-3 md:py-4 ${sticky ? 'sticky top-0 z-50' : ''}`}
      style={{
      ...
      <div className="max-w-[1440px] mx-auto px-4 2xl:px-0 flex justify-between items-center gap-2">
        ...
        <div className="hidden lg:flex items-center gap-8 xl:gap-10">
          {menuLinks.map((link, index) => (
            <a
              key={index}
              href={link.url}
              className="hover:opacity-70 font-roboto font-normal text-sm leading-[100%] transition-colors whitespace-nowrap text-center"
        ...
        <div className="flex items-center gap-2 sm:gap-3 md:gap-4 shrink-0">
          ...
          {show_search && (
            ...
            >
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M17.5605 30C24.4641 30 30.0605 24.4036 30.0605 17.5C30.0605 10.5964 24.4641 5 17.5605 5C10.657 5 5.06055 10.5964 5.06055 17.5C5.06055 24.4036 10.657 30 17.5605 30Z" stroke={text_color} strokeWidth="1.5" strokeLinecap="square" strokeLinejoin="round" />
                <path d="M26.3984 26.3391L35.0594 35" stroke={text_color} strokeWidth="1.5" strokeLinecap="square" strokeLinejoin="round" />
              </svg>
            </button>
          )}
          ...
          {show_cart && (
            ...
            >
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M13.3327 11.6667H26.666C29.8087 11.6667 31.38 11.6667 32.3563 12.643C33.3327 13.6193 33.3327 15.1906 33.3327 18.3333V25C33.3327 30.4997 33.3327 33.2495 31.6242 34.9582C29.9155 36.6667 27.1657 36.6667 21.666 36.6667H18.3327C12.833 36.6667 10.0831 36.6667 8.37457 34.9582C6.66602 33.2495 6.66602 30.4997 6.66602 25V18.3333C6.66602 15.1906 6.66602 13.6193 7.64233 12.643C8.61863 11.6667 10.19 11.6667 13.3327 11.6667Z" stroke={text_color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M26.6673 15.8333C26.6673 9.39003 23.6825 3.33334 20.0007 3.33334C16.3188 3.33334 13.334 9.39003 13.334 15.8333" stroke={text_color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </button>
          )}
            ...
            <div className="flex flex-col">
              {menuLinks.map((link, index) => (
                <a
                  key={index}
                  href={link.url}
                  className={`py-3 text-center transition-colors hover:opacity-70 ${
