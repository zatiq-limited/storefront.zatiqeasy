...
interface AnnouncementBar3Props {
  ...
  // Individual link props from theme builder
  show_left_links?: boolean;
  link1_text?: string;
  link1_url?: string;
  link2_text?: string;
  link2_url?: string;
...
const AnnouncementBar3: React.FC<AnnouncementBar3Props> = ({
  ...
  const bgColor = background_color || backgroundColor || '#6D0AB6';
  const txtColor = text_color || textColor || '#FFFFFF';

  // Build links array from individual props or use legacy links array
  const resolvedLinks = links.length > 0 ? links : [
    ...(link1_text ? [{ text: link1_text, url: link1_url || '#' }] : []),
    ...(link2_text ? [{ text: link2_text, url: link2_url || '#' }] : []),
  ];
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto min-h-14 px-5 py-3 flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-4">
        {show_left_links && resolvedLinks.length > 0 && (
          ...
          {show_email && email && (
            <>
              ...
              >
                ...
                >
                  <path
                    d="M10.0747 10.4164H1.92537C1.43765 10.4158 0.970106 10.2217 0.625274 9.87685C0.280442 9.53195 0.0864818 9.06437 0.0859375 8.57665V3.42317C0.086482 2.93549 0.280453 2.46794 0.625295 2.1231C0.970137 1.77826 1.43769 1.58428 1.92537 1.58374H10.0747C10.5624 1.58428 11.03 1.77824 11.3749 2.12308C11.7198 2.46791 11.9139 2.93546 11.9145 3.42317V8.57665C11.914 9.06443 11.72 9.53206 11.3751 9.87697C11.0301 10.2219 10.5625 10.4159 10.0747 10.4164ZM1.92537 2.44088C1.66493 2.44116 1.41524 2.54473 1.23109 2.72889C1.04693 2.91304 0.943353 3.16273 0.94308 3.42317V8.57665C0.943262 8.83715 1.0468 9.08693 1.23096 9.27116C1.41513 9.45539 1.66487 9.55901 1.92537 9.55928H10.0747C10.3353 9.55901 10.585 9.4554 10.7693 9.27118C10.9535 9.08696 11.0571 8.83718 11.0574 8.57665V3.42317C11.057 3.1627 10.9533 2.91301 10.7691 2.72887C10.5849 2.54472 10.3352 2.44116 10.0747 2.44088H1.92537Z"
                    fill="white"
                  />
                  <path
                    d="M5.99681 7.15362C5.63723 7.15716 5.28694 7.03939 5.00253 6.81933L0.419214 3.16688C0.330329 3.096 0.273241 2.99271 0.26051 2.87974C0.247779 2.76677 0.280447 2.65336 0.351328 2.56448C0.422209 2.47559 0.525497 2.4185 0.638469 2.40577C0.751441 2.39304 0.864843 2.42571 0.953728 2.49659L5.53567 6.14905C5.67103 6.24505 5.83297 6.29642 5.99891 6.29599C6.16486 6.29556 6.32653 6.24335 6.46139 6.14665L10.9868 2.49831C11.0752 2.42697 11.1883 2.39369 11.3013 2.40577C11.4143 2.41786 11.5178 2.47433 11.5892 2.56276C11.6605 2.65119 11.6938 2.76434 11.6817 2.87731C11.6696 2.99029 11.6131 3.09383 11.5247 3.16516L7.0007 6.81351C6.71432 7.03744 6.36033 7.15737 5.99681 7.15362Z"
                    fill="white"
                  />
                </svg>
                <span className="text-sm font-normal">{email}</span>
              </a>
              {show_phone && phone && <span className="text-sm">|</span>}
            </>
          )}
          {show_phone && phone && (
            <a
...
export default AnnouncementBar3;
