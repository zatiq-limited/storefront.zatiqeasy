...
function ProductsLayout({
  ...
  const paginationType = (settings.pagination_type as string) || "products-pagination-1";
  ...
  const cardButtonBgColor = (settings.card_button_bg_color as string) || "#3B82F6";
  const cardButtonTextColor = (settings.card_button_text_color as string) || "#FFFFFF";
  const sidebarButtonBgColor = (settings.sidebar_button_bg_color as string) || "#111827";
  const sidebarButtonTextColor = (settings.sidebar_button_text_color as string) || "#FFFFFF";
  ...
  const renderProductCard = (product: Product) => {
    ...
    switch (cardType) {
      ...
      case "card-4":
        return <ProductCard4 key={product.id} {...commonProps} subtitle={product.short_description} />;
      case "card-5":
        return <ProductCard5 key={product.id} {...commonProps} />;
      case "card-6":
        return <ProductCard6 key={product.id} {...commonProps} rating={product.rating || 0} reviewCount={product.review_count || 0} />;
      case "card-7":
        return <ProductCard7 key={product.id} {...commonProps} colors={product.colors || []} />;
      case "card-8":
        return <ProductCard8 key={product.id} {...commonProps} rating={product.rating || 0} />;
      case "card-9":
        return <ProductCard9 key={product.id} {...commonProps} badge={product.badge} />;
      case "card-10":
        return <ProductCard10 key={product.id} {...commonProps} />;
      case "card-11":
        return <ProductCard11 key={product.id} {...commonProps} badge={product.badge} />;
      case "card-12":
      ...
      case "card-15":
        return <ProductCard15 key={product.id} {...commonProps} badge={product.badge} />;
      case "card-16":
        return <ProductCard16 key={product.id} {...commonProps} />;
      case "card-1":
      default:
        return <ProductCard1 key={product.id} {...commonProps} subtitle={product.short_description} />;
    }
  };
  ...
  const renderPagination = () => {
    ...
    const paginationProps = {
      ...
      to: Math.min(filters.page * (pagination.per_page || 20), pagination.total),
  ...
  return (
    <section className="pb-8">
      ...
      <div className="container mx-auto px-4 2xl:px-0 pt-4">
        ...
        <div className={`flex ${showSidebar ? "gap-8" : ""} ${!isLeftSidebar && showSidebar ? "flex-row-reverse" : ""}`}>
          {/* Sidebar - Desktop */}
          {showSidebar && (
            <>
