...
export default function Category6({ settings, blocks, pageData }: Category6Props) {
  ...
  return (
    <div className="w-full mx-auto px-4 sm:px-6 lg:px-8" style={{ maxWidth }}>
        ...
        {categories.map((category: any, i: number) => (
          <div
            ...
            style={{ 
              ...
              borderRadius: category.borderRadius || borderRadius
            }}
          >
            {/* Left Text Section */}
