...
export default function AnnouncementBar3({ settings, blocks, pageData }: AnnouncementBar3Props) {
  const email = settings?.email || "support@zatiq.com";
  const phone = settings?.phone || "+1-202-555-0173";
  const bgColor = settings?.bgColor || "#6D0AB6";
  const links = settings?.links || [
    { text: "Get in Touch", url: "#" },
    { text: "Refund and Exchange Guidelines", url: "#" }
  ];

  return (
    <div 
      className="max-w-[1440px] mx-auto min-h-16 sm:min-h-14 text-white"
